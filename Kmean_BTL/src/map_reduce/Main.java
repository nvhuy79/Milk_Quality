...
public class Main extends Configured implements Tool {
	public static String path_download_cluster_centers = "H:\\62TH1\\PHAN_TICH_DLL\\PTDLL\\BTL\\cluster_centers.txt";
	public static String path_download_data_output = "H:\\62TH1\\PHAN_TICH_DLL\\PTDLL\\BTL\\data_output.csv";
	...
	public void download_hdfs_local(Configuration conf) {
        try {
	...
	public int run(String[] args) throws Exception {
		...
		String outputFileName = conf.get("result", "cluster_centers.txt");
